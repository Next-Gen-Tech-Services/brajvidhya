        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4 text-base">
              <span className="font-bold text-[#1a3d2b]">Brajvidhya Services Private Limited</span> is an NABCB accredited IB inspection body, recognized by many PSUs, councils and regulatory bodies like FSSAI, IFE, QCI and NDIE — based in <span className="font-semibold">Indore, Madhya Pradesh</span>.
            </p>
